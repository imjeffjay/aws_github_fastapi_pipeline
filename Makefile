...
create-codebuild-project:
	...
	aws codebuild create-project \
		...
		--environment "$(shell jq -n --arg type "LINUX_CONTAINER" \
			--arg image "aws/codebuild/standard:5.0" \
			--arg computeType "BUILD_GENERAL1_SMALL" \
			--arg privilegedMode "true" \
			--argjson environmentVariables '[ \
			...
			'{type:$$type, image:$$image, computeType:$$computeType, privilegedMode:($$privilegedMode|test("true")), environmentVariables:$$environmentVariables}')"
